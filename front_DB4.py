...
def render_center_picker_dialog(BASE_LAT: float, BASE_LON: float):
    ...
    st_map_loc = st_folium(m_loc, key="map_loc_picker", width=900, height=520)
...
with map_col:
    map_state = st_folium(m_store, key="map_store_view", height=600, use_container_width=True)
