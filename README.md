...
- GPT에서 Llama 3.1로 전환하며 출력 품질 직접 비교·검증
...
```bash
git clone https://github.com/Kim-gami/review_project
cd review_project
docker-compose up
# 또는
...
- 5인 팀
- 본인 담당: 크롤링 시스템 설계·DB 스키마 설계·LangChain 파이프라인·Streamlit 기능 구현 및 디버깅·Docker 배포
